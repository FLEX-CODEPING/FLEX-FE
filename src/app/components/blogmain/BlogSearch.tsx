...
import SearchBar from '@/app/components/blogmain/SearchBar';
import Results from '@/app/components/blogmain/Result';  
import Pagination from '@/app/components/blogmain/Pagination';
