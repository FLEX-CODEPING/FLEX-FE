var TradingView = function(e) {
    ...
    t.ChartCrosshairPlusButtonDrawHorizontalLine = "Chart.Crosshair.PlusButton.DrawHorizontalLine",
    ...
    t.ChartDialogsShowGeneralSettingsEventsAndAlertsTab = "Chart.Dialogs.ShowGeneralSettings.EventsAndAlertsTab",
    ...
    t.ChartLegendToggleLastDayChangeValuesVisibility = "Chart.Legend.ToggleLastDayChangeValuesVisibility",
    ...
    t.ChartLegendToggleIndicatorArgumentsVisibility = "Chart.Legend.ToggleIndicatorArgumentsVisibility",
    ...
    t.ChartLegendToggleOpenMarketStatusVisibility = "Chart.Legend.ToggleOpenMarketStatusVisibility",
    ...
    t.ChartLinesTogglePrePostMarketLineVisibility = "Chart.Lines.TogglePrePostMarketLineVisibility",
    t.ChartLinesTogglePrePostMarketPriceLineVisibility = "Chart.Lines.TogglePrePostMarketPriceLineVisibility",
    t.ChartLinesToggleSeriesPrevCloseLineVisibility = "Chart.Lines.ToggleSeriesPrevCloseLineVisibility",
    ...
    t.ChartLineToolPitchforkChangeTypeToModifiedSchiff = "Chart.LineTool.Pitchfork.ChangeTypeToModifiedSchiff",
    t.ChartLineToolPitchforkChangeTypeToOriginal = "Chart.LineTool.Pitchfork.ChangeTypeToOriginal",
    ...
    t.ChartLineToolToolbarChangeFontSizeProperty = "Chart.LineTool.Toolbar.ChangeFontSizeProperty",
    t.ChartLineToolToolbarChangeLineStyleToDashed = "Chart.LineTool.Toolbar.ChangeLineStyleToDashed",
    t.ChartLineToolToolbarChangeLineStyleToDotted = "Chart.LineTool.Toolbar.ChangeLineStyleToDotted",
    t.ChartLineToolToolbarChangeLineStyleToSolid = "Chart.LineTool.Toolbar.ChangeLineStyleToSolid",
    ...
    t.ChartPriceScaleLabelsToggleBidAskLabelsVisibility = "Chart.PriceScale.Labels.ToggleBidAskLabelsVisibility",
    t.ChartPriceScaleLabelsToggleHighLowPriceLabelsVisibility = "Chart.PriceScale.Labels.ToggleHighLowPriceLabelsVisibility",
    t.ChartPriceScaleLabelsToggleAveragePriceLabelVisibility = "Chart.PriceScale.Labels.ToggleAveragePriceLabelVisibility",
    t.ChartPriceScaleLabelsToggleIndicatorsNameLabelsVisibility = "Chart.PriceScale.Labels.ToggleIndicatorsNameLabelsVisibility",
    t.ChartPriceScaleLabelsToggleIndicatorsValueLabelsVisibility = "Chart.PriceScale.Labels.ToggleIndicatorsValueLabelsVisibility",
    t.ChartPriceScaleLabelsTogglePrePostMarketLabelsVisibility = "Chart.PriceScale.Labels.TogglePrePostMarketLabelsVisibility",
    t.ChartPriceScaleLabelsToggleNoOverlappingLabelsVisibility = "Chart.PriceScale.Labels.ToggleNoOverlappingLabelsVisibility",
    t.ChartPriceScaleLabelsToggleSeriesLastValueVisibility = "Chart.PriceScale.Labels.ToggleSeriesLastValueVisibility",
    t.ChartPriceScaleLabelsToggleSymbolNameLabelsVisibility = "Chart.PriceScale.Labels.ToggleSymbolNameLabelsVisibility",
    t.ChartPriceScaleLabelsToggleSymbolPrevCloseValueVisibility = "Chart.PriceScale.Labels.ToggleSymbolPrevCloseValueVisibility",
    ...
    t.ChartPriceScaleToggleAddOrderPlusButtonVisibility = "Chart.PriceScale.ToggleAddOrderPlusButtonVisibility",
    ...
    t.ChartPriceScaleToggleCountdownToBarCloseVisibility = "Chart.PriceScale.ToggleCountdownToBarCloseVisibility",
    ...
    t.ChartSeriesPriceScaleToggleInvertPriceScale = "Chart.Series.PriceScale.ToggleInvertPriceScale",
    ...
    t.ChartToggleVisibilityContinuousContractSwitch = "Chart.ToggleVisibility.ContinuousContractSwitch",
    ...
    t.ChartSourceIntervalsVisibilityCurrentAndAbove = "Chart.Source.IntervalsVisibility.CurrentAndAbove",
    t.ChartSourceIntervalsVisibilityCurrentAndBelow = "Chart.Source.IntervalsVisibility.CurrentAndBelow",
    ...
    (z = e.OrderTicketFocusControl || (e.OrderTicketFocusControl = {}))[z.LimitPrice = 1] = "LimitPrice",
    ...
    (q = e.OrderOrPositionMessageType || (e.OrderOrPositionMessageType = {})).Information = "information",
    q.Warning = "warning",
    q.Error = "error",
    function(e) {
        e.Demo = "demo",
    ...
    ie.Empty = "empty",
    (oe = e.OverridePriceAxisLastValueMode || (e.OverridePriceAxisLastValueMode = {}))[oe.LastPriceAndPercentageValue = 0] = "LastPriceAndPercentageValue",
    ...
    (he = e.TradedGroupHorizontalAlignment || (e.TradedGroupHorizontalAlignment = {}))[he.Left = 0] = "Left",
    ...
    function ve(e, t) {
        ...
        for (const o in t)
            "object" != typeof e[o] || null === e[o] || Array.isArray(e[o]) ? void 0 !== t[o] && (i[o] = t[o]) : i[o] = ve(e[o], t[o]);
        return i
    }
    !function(e) {
    ...
    let Re = !1;
    function De() {
        return "CL v28.4.0 (internal id c30d174a @ 2024-11-29T13:11:24.945Z)"
    }
    const Ve = class {
        constructor(e) {
            var t, i;
            ...
            (null === (t = e.overrides) || void 0 === t ? void 0 : t["mainSeriesProperties.priceAxisProperties.lockScale"]) && (console.warn("mainSeriesProperties.priceAxisProperties.lockScale can not be set to true within the widget constructor"),
            ...
            (this._options.debug || this._options.debug_broker) && (Re || (Re = !0,
            console.log("Using CL v28.4.0 (internal id c30d174a @ 2024-11-29T13:11:24.945Z)"))),
        ...
        async _create() {
            ...
            d.innerHTML = a,
            this._iFrame = d.querySelector(`#${this._id}`);
            const c = this._iFrame;
            r && await this._innerWindowEvent("sameOriginLoad"),
            n && (c.contentWindow ? (c.contentWindow.document.open(),
            c.contentWindow.document.write(s),
            c.contentWindow.document.close()) : console.warn("Unable to locate contentWindow for the created iframe. Please try disabling the `iframe_loading_compatibility_mode` featureset.")),
            this._innerWindow().addEventListener("innerWindowLoad", function(e, t) {
                if (void 0 === e)
            ...
            (this._options.autosize || this._options.fullscreen) && (c.style.width = "100%",
        ...
        _render(e, t) {
            ...
            if (this._options.library_path && !this._options.library_path.endsWith("/") && console.warn("library_path option should contain a trailing forward slash"),
            this._options.locale) {
                const e = encodeURIComponent(this._options.locale);
                Oe.findIndex((t => t.language === e)) >= 0 || (console.warn("locale isn't supported. Using default of `en`."),
                this._options.locale = "en")
            }
            const r = function(e, t) {
                var i;
                const o = new URL(`${e || ""}`,location.href).href
                  , r = JSON.parse('["bundles/runtime.45222d21327e712692d2.js","bundles/__LANG__.5826.82f25d5636541df34beb.js","bundles/9662.03109f673cda5962c847.css","bundles/7346.a2efeed47130dd4e832c.js","bundles/library.cb873585ffc0b08e6bdf.js"]')
                  ...
                  , l = `\n${function(e, t, i) {
                    ...
                    const o = []
                      , r = [];
                    for (const n of e)
                        n.endsWith(".js") ? o.push(`<script defer crossorigin="anonymous" src="${n.replace("__LANG__", i)}"><\/script>`) : n.endsWith(".css") && r.push(`<link type="text/css" href="${t ? n.replace(/\.css$/i, ".rtl.css") : n}" rel="stylesheet"/>`);
                    return [...o, ...r].join("\n")
                }(r, "rtl" === a.dir, n)}\n`;
